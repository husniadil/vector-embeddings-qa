...
def create_hardcoded_multi_tool_agent():
    """Create a Level 2 agent - Hardcoded Multi-Tool Agent
...
def main():
    print("Creating a Level 2 Agent - Hardcoded Multi-Tool Agent...")
    agent = create_hardcoded_multi_tool_agent()

    print("\n=== Level 2: Hardcoded Multi-Tool Agent Demo ===")
    print("This demo shows an agent that follows a predefined sequence of steps (static flow).")
    print("Suitable for simple automation processes (RPA style).")
    print("The workflow is: Search product → check details → check stock → add to cart → process order")
